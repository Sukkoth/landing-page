function JoinForm() {
  return (
    <form className='flex flex-col space-y-10 mt-10'>
      <input
        type='text'
        placeholder='Name'
        className='border-b border-b-white/55 bg-transparent outline-none w-[30rem] text-xl pb-2'
      />
      <input
        type='email'
        placeholder='Email'
      ...
      <select
        name='country'
        id='country'
        className='border-b border-b-white/55 bg-transparent outline-none w-[30rem] text-white text-xl pb-2'
      >
